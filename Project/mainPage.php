...
<head>
    ...
    <link rel="stylesheet" href="lib/css/mainPage.css">

    <link href='http://fonts.googleapis.com/css?family=Lato:400,700' rel='stylesheet' type='text/css'>

    <script type="text/javascript" src="lib/js/mainPage.js"></script>
...
<div class="subpage"  id="subpage">
    ...
    <div class="row" id="welcomeInfo">
        <div id="coverPhoto" class="column three"><img id="drvenija" src="Pictures/knjige2.jpg">
