    ...
    <div class="column four">
            ...
            <div class="column seven">
                <div class="gallery" align="center">
                    ...
                    <div class="thumbnails">
                        <img onmouseover="preview.src=img1.src" name="img1" src="Pictures/bosanski.jpg" alt="" />
                        <img onmouseover="preview.src=img2.src" name="img2" src="Pictures/mojaOkolina.jpg" alt="" />
                        <img onmouseover="preview.src=img3.src" name="img3" src="Pictures/matematika2.jpg" alt="" />
                        <img onmouseover="preview.src=img4.src" name="img4" src="Pictures/historija.jpg" alt="" />
                        <img onmouseover="preview.src=img5.src" name="img5" src="Pictures/biologija.jpg" alt="" />
                    </div>
                    <div class="preview">
                        <img name="preview" id="previewImage" onclick="load()" src="Pictures/historija.jpg" alt=""/>
        ...
        <div class="row one">
            <div class="column five">
                <img src="Pictures/matematika2.jpg">
            </div>
        ...
        <div class="row one">
            <div class="column five">
                <img src="Pictures/biologija.jpg">
            </div>
            <div class="column six">
                <p>
        ...
        <div class="row one">
            <div class="column five">
                <img src="Pictures/historija.jpg">
            </div>
            <div class="column six">
                <p>
                    Mogućnost razmjene: <b>DA</b> <br>
